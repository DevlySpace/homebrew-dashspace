class Dashspace < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/devlyspace/devly-cli/releases/download/0.0.4/dashspace-darwin-arm64"
      sha256 "d0aef668a3798d5baaf8ff6f62c8484a73b63284ca535f80560fce9bee914f6b"
    else
      url "https://github.com/devlyspace/devly-cli/releases/download/0.0.4/dashspace-darwin-amd64"
  ...
  test do
    ...
    assert_match "dashspace version 0.0.4", shell_output("#{bin}/dashspace --version")
  end
end
